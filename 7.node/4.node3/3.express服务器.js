...
/*(1)在Node.js课程中，我们所有说的“路由”,默认都是指【后端路由】
  (2)路由可以理解为：一组key-value的组合，key:请求方式 + URI路径, key匹配上了就交给value:回调函数
...
app.get('/' , function (request , response){
  /* 问题：是什么样的请求，能交给这个回调函数处理
    1、请求方式必须为GET，post请求不行
    2、请求的URI必须为"/"  ，从/开始划分的地址
  */
